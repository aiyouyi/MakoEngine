...
#define jce_htonl jce__bswap_constant_32
...
inline Int64 jce_htonll(Int64 x)
{
        jce::bswap_helper h;
        h.i64 = x;
        Int32 tmp = jce_htonl(h.i32[1]);
        h.i32[1] = jce_htonl(h.i32[0]);
        h.i32[0] = tmp;
        return h.i64;
}
inline Float jce_ntohf(Float x)
{
    Int32 __t__ = jce_htonl((*((Int32 *)&x)));
    return *((Float *) &__t__);
}
...
template<> struct Class<taf::Bool>   { static std::string name() { return "bool"; } };
template<> struct Class<taf::Char>   { static std::string name() { return "char"; } };
template<> struct Class<taf::Short>  { static std::string name() { return "short"; } };
template<> struct Class<taf::Float>  { static std::string name() { return "float"; } };
template<> struct Class<taf::Double> { static std::string name() { return "double"; } };
template<> struct Class<taf::Int32>  { static std::string name() { return "int32"; } };
template<> struct Class<taf::Int64>  { static std::string name() { return "int64"; } };
template<> struct Class<std::string> { static std::string name() { return "std::string"; } };
