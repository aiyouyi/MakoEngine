#ifndef _CC_TRANSFORM_H_
#define _CC_TRANSFORM_H_
...
public:
	...
	public:
		 ...
		 */
		virtual void transformChanged(CC3DTransform* transform, long cookie) = 0;
	};
	 ...
	 */
	CC3DTransform(const Vector3& scale, const CC3DMath::CC3DQuaternion& rotation, const Vector3& translation);
	 ...
	 * @param translation The translation vector.
	 */
	CC3DTransform(const Vector3& scale, const CC3DMath::CC3DMatrix& rotation, const Vector3& translation);
	 ...
	 */
	CC3DTransform(const CC3DTransform& copy);
	 ...
	 */
	const CC3DMath::CC3DMatrix& getMatrix() const;
	 ...
	 */
	const CC3DMath::CC3DQuaternion& getRotation() const;
	 ...
	 */
	void getRotation(CC3DMath::CC3DQuaternion* rotation) const;
	 ...
	 */
	void getRotation(CC3DMath::CC3DMatrix* rotation) const;
	 ...
	 */
	void rotate(const CC3DMath::CC3DQuaternion& rotation);
	 ...
	 */
	void rotate(const CC3DMath::CC3DMatrix& rotation);
	 ...
	 * @param translation The translation vector.
	 */
	void set(const Vector3& scale, const CC3DMath::CC3DQuaternion& rotation, const Vector3& translation);
	 ...
	 * @param translation The translation vector.
	 */
	void set(const Vector3& scale, const CC3DMath::CC3DMatrix& rotation, const Vector3& translation);
	 ...
	 */
	void set(const CC3DTransform& transform);
	 ...
	 */
	void setRotation(const CC3DMath::CC3DQuaternion& rotation);
	 ...
	 */
	void setRotation(const CC3DMath::CC3DMatrix& rotation);
	 ...
	 */
	void addListener(CC3DTransform::Listener* listener, long cookie = 0);
	 ...
	 */
	void removeListener(CC3DTransform::Listener* listener);
...
public:
	 ...
	 */
	CC3DMath::CC3DQuaternion _rotation;
	 ...
	 */
	mutable CC3DMath::CC3DMatrix _matrix;
	...
	CC3DMath::CC3DQuaternion	localRotation;

	Vector3					worldPosition;
	CC3DMath::CC3DQuaternion	worldRotation;

	CC3DMath::CC3DMatrix		localToWorld;
	CC3DMath::CC3DMatrix		worldToLocal;

	glm::mat4				glm_localToWorld;
	glm::mat4				glm_worldToLocal;
...
private:
	...
	static std::vector<CC3DTransform*> _transformsChanged;
