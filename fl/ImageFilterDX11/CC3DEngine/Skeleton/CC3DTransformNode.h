#ifndef _CC_TRANSFORM_NODE_H_
#define _CC_TRANSFORM_NODE_H_
...
class CC3DTransformNode : public CC3DTransform
{
...
public:
	 ...
	 * @script{create}
	 */
	static CC3DTransformNode* create(const char* id = nullptr);

	/**
	 * Extends ScriptTarget::getTypeName() to return the type name of this class.
	 *
	 * @return The type name of this class: "CC3DTransformNode"
	 ...
	 */
	virtual CC3DTransformNode::Type getType() const;
	 ...
	 */
	virtual void addChild(CC3DTransformNode* child);

	/**
	 * Adds a child node to the end of the Single list structure
	 *
	 * @param child The child to add.
	*/
	virtual void addToSingleListEnd(CC3DTransformNode* child);
	 ...
	 */
	virtual void removeChild(CC3DTransformNode* child);
	 ...
	 */
	CC3DTransformNode* getFirstChild() const;
	 ...
	 */
	CC3DTransformNode* getNextSibling() const;
	 ...
	 */
	CC3DTransformNode* getPreviousSibling() const;
	 ...
	 * @return The parent.
	 */
	CC3DTransformNode* getParent() const;
	 ...
	 */
	CC3DTransformNode* getRootNode() const;
	 ...
	 * If recursive is true, it also traverses the CC3DTransformNode's hierarchy with a breadth first search.
	 *
	 ...
	 *
	 * @return The CC3DTransformNode found or NULL if not found.
	 */
	CC3DTransformNode* findNode(const char* id, bool recursive = true, bool exactMatch = true) const;
	 ...
	 * @script{ignore}
	 */
	unsigned int findNodes(const char* id, std::vector<CC3DTransformNode*>& nodes, bool recursive = true, bool exactMatch = true) const;
	...
	/**
	 * Sets a tag on this CC3DTransformNode.
	 *
	 ...
	 *
	 * Setting a tag to NULL removes the tag from the CC3DTransformNode.
	 *
	...
	/**
	 * Called to update the state of this CC3DTransformNode.
	 *
	 * This method is called by Scene::update(float) to update the state of all active
	 * nodes in a scene. A CC3DTransformNode is considered active if CC3DTransformNode::isActive() returns true.
	 *
	 ...
	 *
	 * @return True if the transformation of this CC3DTransformNode is static, false otherwise.
	 *
	 ...
	 */
	virtual const CC3DMath::CC3DMatrix& getWorldMatrix() const;
	...
	/**
	 * Gets the translation vector (or position) of this CC3DTransformNode in world space.
	 *
	...
	/**
	 * Gets the translation vector (or position) of this CC3DTransformNode in view space.
	 *
	...
	/**
	 * Returns the forward vector of the CC3DTransformNode in world space.
	 *
	...
	/**
	 * Returns the forward vector of the CC3DTransformNode in view space.
	 *
	...
	/**
	 * Returns the right vector of the CC3DTransformNode in world space.
	 *
	...
	/**
	 * Returns the up vector of the CC3DTransformNode in world space.
	 *
	...
	*/
	...
	/**
	 * Returns the bounding sphere for the CC3DTransformNode, in world space.
	 *
...
public:
	 ...
	 * Constructor.
	 */
	CC3DTransformNode(const char* id);

	/**
	 * Destructor.
	 */
	virtual ~CC3DTransformNode();
	 ...
	 */
	//virtual CC3DTransformNode* cloneSingleNode(NodeCloneContext &context) const;
	 ...
	 */
	//CC3DTransformNode* cloneRecursive(NodeCloneContext &context) const;
	 ...
	 * @param context The clone context.
	 */
	//void cloneInto(CC3DTransformNode* node, NodeCloneContext &context) const;
	...
	/**
	 * Called when this CC3DTransformNode's transform changes.
	 */
	//void transformChanged();

	/**
	 * Called when this CC3DTransformNode's hierarchy changes.
	 */
//	void hierarchyChanged();
	 ...
	 * @return The CC3DTransformNode found or NULL if not found.
	 */
	CC3DTransformNode* findNode(const char* id, bool recursive, bool exactMatch, bool skipSkin) const;
	 ...
	 * @script{ignore}
	 */
	unsigned int findNodes(const char* id, std::vector<CC3DTransformNode*>& nodes, bool recursive, bool exactMatch, bool skipSkin) const;
...
private:
	 ...
	 */
	CC3DTransformNode(const CC3DTransformNode& copy);

	/**
	 * Hidden copy assignment operator.
	 */
	//CC3DTransformNode& operator=(const CC3DTransformNode&);
...
public:
	...
	CC3DTransformNode* _firstChild;
	/** The nodes next sibiling. */
	CC3DTransformNode* _nextSibling;
	/** The nodes previous sibiling. */
	CC3DTransformNode* _prevSibling;
	/** The nodes parent. */
	CC3DTransformNode* _parent;
	...
	mutable CC3DMath::CC3DMatrix _world;
...
public:
	 ...
	 */
	CC3DTransformNode* findClonedNode(const CC3DTransformNode* node);
	 ...
	 */
	void registerClonedNode(const CC3DTransformNode* original, CC3DTransformNode* clone);
...
private:
	...
	std::map<const CC3DTransformNode*, CC3DTransformNode*> _clonedNodes;
};
