#ifndef SIMPLE_FACE_BACK_RECONSTRUCTOR_H_
#define SIMPLE_FACE_BACK_RECONSTRUCTOR_H_
...
{ 
	 ...
	 */
	class SimpleFaceBackMesh:public SimpleMesh
	{
	public:
		SimpleFaceBackMesh() = default;
		~SimpleFaceBackMesh() override ;
		/**
		* @brief 初始化相关simple face and back mesh的数据
		*/
		...
		*/
		virtual bool Run(const float *pImagePoint, const float fWidthImage, const float fHeightImage, const float fFacePitchAngle) override;
