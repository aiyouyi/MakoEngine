#ifndef _CC3D_MATRIX_H_
#define _CC3D_MATRIX_H_
...
namespace CC3DMath
{
	...
	public:
		 ...
		 */
		CC3DMatrix(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
		 ...
		 */
		CC3DMatrix(const CC3DMatrix& copy);
		 ...
		 */
		static const CC3DMatrix& identity();
		 ...
		 */
		static void createLookAt(const Vector3& eyePosition, const Vector3& targetPosition, const Vector3& up, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createPerspective(float fieldOfView, float aspectRatio, float zNearPlane, float zFarPlane, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createOrthographic(float width, float height, float zNearPlane, float zFarPlane, CC3DMatrix* dst);
		...
		/**
		 * Fills in an existing CC3DMatrix so that it reflects the coordinate system about a specified Plane.
		 *
		 * @param plane The Plane about which to create a reflection.
		 * @param dst A matrix to store the result in.
		 */
		 //static void createReflection(const Plane& plane, CC3DMatrix* dst);
		  ...
		  * @param dst A matrix to store the result in.
		  */
		static void createScale(const Vector3& scale, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createScale(float xScale, float yScale, float zScale, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createRotation(const CC3DQuaternion& quat, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createRotation(const Vector3& axis, float angle, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createRotationX(float angle, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createRotationY(float angle, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createRotationZ(float angle, CC3DMatrix* dst);
		...
		* @param dst A matrix to store the result in.
		*/
		static void createFromEuler(float yaw, float pitch, float roll, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createTranslation(const Vector3& translation, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void createTranslation(float xTranslation, float yTranslation, float zTranslation, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void add(float scalar, CC3DMatrix* dst);
		 ...
		 */
		static void add(const CC3DMatrix& m1, const CC3DMatrix& m2, CC3DMatrix* dst);
		 ...
		 * @param translation The translation.
		 */
		bool decompose(Vector3* scale, CC3DQuaternion* rotation, Vector3* translation) const;
		 ...
		 */
		bool getRotation(CC3DQuaternion* rotation) const;
		 ...
		 * @return true if the the matrix can be inverted, false otherwise.
		 */
		bool invert(CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void multiply(float scalar, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void multiply(const CC3DMatrix& m, float scalar, CC3DMatrix* dst);
		 ...
		 */
		void multiply(const CC3DMatrix& m);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void multiply(const CC3DMatrix& m1, const CC3DMatrix& m2, CC3DMatrix* dst);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void negate(CC3DMatrix* dst) const;
		 ...
		 */
		void rotate(const CC3DQuaternion& q);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void rotate(const CC3DQuaternion& q, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void rotate(const Vector3& axis, float angle, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void rotateX(float angle, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void rotateY(float angle, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void rotateZ(float angle, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void scale(float value, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void scale(float xScale, float yScale, float zScale, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void scale(const Vector3& s, CC3DMatrix* dst) const;
		 ...
		 */
		void subtract(const CC3DMatrix& m);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		static void subtract(const CC3DMatrix& m1, const CC3DMatrix& m2, CC3DMatrix* dst);
		...
		Vector3 inverseTransformPoinit(Vector3 point);
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void translate(float x, float y, float z, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void translate(const Vector3& t, CC3DMatrix* dst) const;
		 ...
		 * @param dst A matrix to store the result in.
		 */
		void transpose(CC3DMatrix* dst) const;
		 ...
		 */
		inline const CC3DMatrix operator+(const CC3DMatrix& m) const;
		 ...
		 */
		inline CC3DMatrix& operator+=(const CC3DMatrix& m);
		 ...
		 */
		inline const CC3DMatrix operator-() const;
		...
		inline const Vector3 multiplyVector3(const Vector3& rhs) const
		{
