...
struct mat4 {
	...
	float det() const {
		float det;
		det = mat[0]*( mat[5]*(mat[10]*mat[15] - mat[14]*mat[11]) + mat[9]*(mat[14]*mat[7]-mat[6]*mat[15]) + mat[13]*(mat[6]*mat[11] - mat[10]*mat[7]) );
		det-= mat[4]*( mat[1]*(mat[10]*mat[15] - mat[14]*mat[11]) + mat[9]*(mat[14]*mat[3]-mat[2]*mat[15]) + mat[13]*(mat[2]*mat[11] - mat[10]*mat[3]) );
		det+= mat[8]*( mat[1]*(mat[6]*mat[15] - mat[14]*mat[7]) + mat[5]*(mat[14]*mat[3]-mat[2]*mat[15]) + mat[13]*(mat[2]*mat[7] - mat[6]*mat[3]) );
		det-= mat[12]*( mat[1]*(mat[6]*mat[11] - mat[10]*mat[7]) + mat[5]*(mat[10]*mat[3]-mat[2]*mat[11]) + mat[9]*(mat[2]*mat[7] - mat[6]*mat[3]) );
		return det;
	}
	...
	{
		mat[0] = 2*n/(r-l);		mat[1] = 0;				mat[2] = 0;			mat[3] = 0;
		mat[4] = 0;				mat[5] = 2*n/(t-b);		mat[6] = 0;			mat[7] = 0;
		mat[8] = (r+l)/(r-l);	mat[9] = (t+b)/(t-b);	mat[10] = -(f+n)/(f-n); mat[11] = -1;
		mat[12] = 0;			mat[13] = 0;			mat[14] = -2*f*n/(f-n);	mat[15] = 0; 
	}
