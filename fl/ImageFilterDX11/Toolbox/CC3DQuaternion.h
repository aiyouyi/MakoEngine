#ifndef _CC3D_QUATERNION_H_
#define _CC3D_QUATERNION_H_
...
namespace CC3DMath
{
	...
	public:
		 ...
		 */
		CC3DQuaternion(float x, float y, float z, float w);
		 ...
		 * @param m The matrix.
		 */
		CC3DQuaternion(const CC3DMatrix& m);
		 ...
		 */
		CC3DQuaternion(const Vector3& axis, float angle);
		 ...
		 */
		CC3DQuaternion(const CC3DQuaternion& copy);
		 ...
		 */
		static const CC3DQuaternion& identity();
		 ...
		 */
		static const CC3DQuaternion& zero();
		...
		*/
		static void createFromEuler(float yaw, float pitch, float roll, CC3DQuaternion* dst);
		 ...
		 */
		static void createFromRotationMatrix(const CC3DMatrix& m, CC3DQuaternion* dst);
		 ...
		 * @param dst A quaternion to store the conjugate in.
		 */
		static void createFromAxisAngle(const Vector3& axis, float angle, CC3DQuaternion* dst);
		...
		*/
		 ...
		 * @param dst A quaternion to store the conjugate in.
		 */
		void conjugate(CC3DQuaternion* dst) const;
		 ...
		 * @return true if the inverse can be computed, false otherwise.
		 */
		bool inverse(CC3DQuaternion* dst) const;
		 ...
		 */
		void multiply(const CC3DQuaternion& q);
		 ...
		 * @param dst A quaternion to store the result in.
		 */
		static void multiply(const CC3DQuaternion& q1, const CC3DQuaternion& q2, CC3DQuaternion* dst);
		 ...
		 * @param dst A quaternion to store the result in.
		 */
		void normalize(CC3DQuaternion* dst) const;
		...
		*/
		 ...
		 */
		void set(const CC3DQuaternion& q);
		...
		*   toDirection:
		*/
		static CC3DQuaternion FromToRotation(Vector3 fromDirection, Vector3 toDirection);
		 ...
		 * @param dst A quaternion to store the result in.
		 */
		static void lerp(const CC3DQuaternion& q1, const CC3DQuaternion& q2, float t, CC3DQuaternion* dst);
		 ...
		 * @param dst A quaternion to store the result in.
		 */
		static void slerp(const CC3DQuaternion& q1, const CC3DQuaternion& q2, float t, CC3DQuaternion* dst);
		 ...
		 * @param dst A quaternion to store the result in.
		 */
		static void squad(const CC3DQuaternion& q1, const CC3DQuaternion& q2, const CC3DQuaternion& s1, const CC3DQuaternion& s2, float t, CC3DQuaternion* dst);
		 ...
		 */
		inline const CC3DQuaternion operator*(const CC3DQuaternion& q) const;
		 ...
		 */
		inline CC3DQuaternion& operator*=(const CC3DQuaternion& q);
	...
	private:
		...
		static void slerpForSquad(const CC3DQuaternion& q1, const CC3DQuaternion& q2, float t, CC3DQuaternion* dst);
	};
}

#include "CC3DQuaternion.inl"
