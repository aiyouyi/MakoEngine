...
void FGame::Init()
{
	GLBScene=GLBMeshPool::GetInstance()->GetGLBMesh(L"C:\\Mako\\learncode\\makoengine\\MakoEngine\\Resource\\DamagedHelmet.glb");
...
void FGame::Tick()
{
	...
	DX12Base->D3D12GraphicsCommandList->Reset(DX12Base->D3D12CommandAllocator.get(), DX12Base->);
